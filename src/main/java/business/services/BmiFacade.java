...
public class BmiFacade
{
    ...
    public void insertBmiEntry(
            double bmi, double height, double weight, String category, String gender,
            int sport_id,int user_id, List<Integer> hobbyList) throws UserException
    {
    ...
    public int deletSport(int sportId)throws UserException
    {
        return bmiMapper.deletSport(sportId);
    }
    ...
    public int updateSports(int sportId, String name)throws UserException
    {
        return bmiMapper.updateSports(sportId,name);
    }
}
