            ...
            <table class="table">
                ...
                <c:forEach var="sportItem" items="${applicationScope.sportList}">
                    <tr>
                        ...
                        <td><button class="btn btn-danger btn-sm" type="submit" name="delete" value="${sportItem.sport_id}">Fjern</button>
                        <td><button class="btn btn-primary btn-sm" type="submit" name="edit" value="${sportItem.sport_id}">Rediger</button>
                        </td>
                    </tr>
                </c:forEach>
            </table>
